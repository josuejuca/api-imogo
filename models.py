...
class Imoveis(Base):
    ...
    status = Column(Integer, nullable=False)
    classificacao = Column(Enum("Comercial", "Residencial", "Outros"), nullable=True)
    ...
    situacao_imovel = Column(Enum("Vago", "Ocupado", "Alugado", "Ocupado pelo Proprietário", "Em Construção"), nullable=True)
